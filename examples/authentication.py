...
The Meta Ads  server supports three authentication modes:
...
3. **Production OAuth Flow** (NEW)
   ...
   - Supports  clients that implement OAuth 2.0 discovery
        ...
        try:
            ...
            if access_token:
                return json.dumps({
                    ...
                    "ready_to_use": "You can now use all Meta Ads  tools and commands."
                }, indent=2)
...
# Conditionally register as  tool only when enabled
if ENABLE_LOGIN_LINK:
    get_login_link = Example_server.tool()(get_login_link)