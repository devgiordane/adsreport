"""Core functionality for Meta Ads API  package."""
...
from .openai_deep_research import search, fetch  # OpenAI  Deep Research tools
...
__all__ = [
    ...
    'search',  # OpenAI  Deep Research search tool
    'fetch',   # OpenAI  Deep Research fetch tool
] 